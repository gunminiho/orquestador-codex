...
export class BackendAgent {
  ...
  async start(
    ...
    await this.client.runTurn(
      this.threadId,
      "Materialize this persistent thread. Do not inspect files, run commands, or modify anything. Reply BACKEND_READY.",
    );
  ...
  private requireThread() {
    if (!this.threadId) throw new Error("Backend thread has not been started.");
